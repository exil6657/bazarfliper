...
public class CustomSlider {
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY) {
        ...
        // Track rectangle
        try {
            context.blit(GuiTextures.PROGRESS_BG, x, trackY, 0,0, width, trackH, width, trackH);
        } catch (Exception e) {
        ...
        try {
            context.blit(GuiTextures.PROGRESS_FILL, x, trackY, 0,0, fillW, trackH, fillW, trackH);
        } catch (Exception e) {
        ...
        context.drawString(mc.font, display, x, y-10, ColorUtils.SECONDARY_TEXT, false);
    }
}
