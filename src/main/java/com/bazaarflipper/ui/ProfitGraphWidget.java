...
/**
 * Simple sparkline graph drawn entirely via GuiGraphicsExtractor.fill()
 */
public class ProfitGraphWidget {

    public void render(GuiGraphicsExtractor context, int x, int y, int width, int height, List<Double> values) {
